...
class AnimalController {
    ...
    public function listAnimals()
    {
        ...
        // Vérifie que des animaux sont bien renvoyés
        if ($animals) {
            // Affiche la vue list.php en passant les animaux
...
public function editAnimal()
{
    if (isset($_GET['id'])) {
        ...
        // Passer l'animal et les habitats à la vue
        $view = __DIR__ . '/../../Views/admin/animals/edit.php'; 
        require_once __DIR__ . '/../../Views/layouts/templatedashboard.php'; 
    } else {
        header('Location: /index.php?controller=animal&action=listAnimals');
...
public function deleteAnimal()
{
    if (isset($_GET['id'])) {
        ...
        // Si aucun ID n'est passé ou s'il y a un problème, on redirige vers la liste
        header('Location: /index.php?controller=animal&action=listAnimals');
        exit;
    }
}
     ...
     public function showAnimalDetails()
    {
        ...
        $animal_id = $_GET['id'];
        // Utilisation de la méthode findWithHabitat du modèle Animal
